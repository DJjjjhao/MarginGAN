...
class MarginGAN_UG(object):
    ...
    def train(self):
        ...
        for epoch in range(self.epoch):
            ...
            if epoch == 0:
                ...
                while True:
                    ...
                    if correct_rate > 0.9:
                        with open('acc_time/stop_' + str(self.lrC), 'a') as f:
                            f.write('UG:' + str(self.index) + ' ' + str(correct_rate) + '\n')
                        break
            ...
            for iter, (x_u, y_u) in enumerate(self.unlabeled_loader):
                ...
                C_loss = C_unlabeled_loss + C_fake_loss
            ...
            with open('acc_time/UG/' + str(self.index) + '_' + str(self.lrC), 'a') as f:
        ...
        with open('acc_time/UG/best_' + str(self.lrC), 'a') as f:
    ...
    def visualize_results(self, epoch, fix=True):
        ...
        path = self.result_dir + '/UG/' + self.model_name + '_' + str(self.index)
    ...
    def save(self):
        ...
        save_dir = self.save_dir + '/UG/' + self.model_name + '_' + str(self.index)
