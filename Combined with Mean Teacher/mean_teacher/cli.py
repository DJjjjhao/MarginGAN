...
def create_parser():
    ...
    parser.add_argument('--generated-batch-size', type=int, default=16, help='The size of  generated batch')  # # #
    parser.add_argument('--z-dim', type=int, default=100, help='dim of noise')  # # #
